  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
        <div className="mt-12 p-8 md:p-24 bg-white border border-graphite/5 rounded-[3rem] text-left relative overflow-hidden shadow-sm">
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-16 items-center">
            <div>
              <h3 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-graphite mb-6 whitespace-pre-line break-words">
